...
Use conventional commits. For the contributor workflow around local checks and commits, see [Commit style](/web-site/local-development/#commit-style).

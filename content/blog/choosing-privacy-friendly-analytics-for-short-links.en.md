...
Traffic stopped before the Worker, such as requests blocked by Cloudflare Access, WAF rules, rate limiting, or bot controls, will not appear in analytics because vanityURLs never receives it.

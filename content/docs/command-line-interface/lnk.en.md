...
Use it when you want the change to become part of your Git history and deploy through the normal Worker workflow. Use [Local helper](/docs/command-line-interface/local-helper/) when you only want to open an existing redirect from the terminal.

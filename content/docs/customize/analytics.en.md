...
Requests blocked by Cloudflare before the Worker do not emit vanityURLs analytics events. Review WAF, rate limiting, bot, and AI crawler decisions with [Network protection](/docs/customize/network-protection/), and review Access decisions with [Access control](/docs/customize/access-control/).

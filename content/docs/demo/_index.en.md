---
aside: false
title: "Demo configuration: v8s.link"
description: "Configuration values used by the public v8s.link demo instance."
weight: 50

---

v8s.link is the public demo instance for vanityURLs. Use this page as the configuration reference for the values used throughout [Quickstart](/docs/setup/quickstart/), then use [Demo operation](/docs/demo/links/) to inspect links, lifecycle states, and live paths.
...
Use this configuration to compare your first deployment against a known working baseline. Then move to [Demo operation](/docs/demo/links/) when you want to see how the running instance behaves.

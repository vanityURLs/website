...
| --------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------- |
| `build/v8s.json`                  | Runtime link registry JSON, `schema_version: "3.0"` | `generated_at`, `generated_timezone`, `default_state`, `routing`, `tree`, `links[]`; each link has `slug`, `match`, `target`, `state`, metadata, and optional `schedule` | `scripts/build-redirect-targets.mjs`    |

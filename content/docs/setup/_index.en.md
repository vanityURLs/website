...
[Quickstart](/docs/setup/quickstart/) is about making the redirector work, so use simple answers; you will be able to refine them during [customization](/docs/customize/).
